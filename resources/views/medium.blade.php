...
<body>
    ...
    <div id="level5Content" style="display: none;">
        ...
        <div class="object-detection-container" style="position: relative;">
            ...
            <!-- Add more detection zones as needed -->
        </div>
...
function initializeLevel5() {
    ...
    // Define multiple detection zones with coordinates
    const detectionZones = [
        { xStart: 100, xEnd: 200, yStart: 150, yEnd: 250 }, // Zone 1
        { xStart: 300, xEnd: 400, yStart: 100, yEnd: 200 }, // Zone 2
        { xStart: 450, xEnd: 550, yStart: 250, yEnd: 350 }, // Zone 3
    ...
    objectImage.addEventListener('click', function(event) {
        ...
        // Check if the click is within any detection zone
