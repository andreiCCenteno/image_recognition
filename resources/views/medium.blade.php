...
<div id="learning-modal">
    ...
    <div id="level5Content" style="display: block;">
        ...
        <img id="objectImage" src="{{ asset('images/medium/city.jpg') }}" style="max-width: 100%; height: auto; cursor: pointer;">
    
            <!-- Large Detection Zones -->
            <div id="farthestpost" class="detection-zone" style="left: 65px; top: 70px; width: 5px; height: 200px;"></div>
            <div id="man" class="detection-zone" style="left: 150px; top: 235px; width: 10px; height: 40px;"></div>
            <div id="closepost" class="detection-zone" style="left: 645px; top: 10px; width: 25px; height: 320px;"></div>
            <div id="car" class="detection-zone" style="left: 70px; top: 250px; width: 70px; height: 30px;"></div>
            <div id="yellowpole" class="detection-zone" style="left: 730px; top: 250px; width: 25px; height: 70px;"></div>
            <div id="mailbox" class="detection-zone" style="left: 480px; top: 250px; width: 25px; height: 50px;"></div>
            <div id="newspaperbox" class="detection-zone" style="left: 410px; top: 250px; width: 25px; height: 50px;"></div>
