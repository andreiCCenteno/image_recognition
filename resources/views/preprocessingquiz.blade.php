...
<head>
    ...
    <style>
        ...
        #gameScene {
            ...
            margin: auto;
            /* Centers horizontally within flex container */
        ...
        #guessContainer {
            ...
            flex-wrap: wrap;
            margin-top: 55px;
            /* Space between image and choices */
            padding: 10px;
        ...
        .choice-button {
            ...
            border: none;
            border-radius: 8px;
            /* Increased border-radius for smoother curves */
            cursor: pointer;
            ...
            /* Uppercase text for buttons for emphasis */
            font-weight: bold;
            /* Bold text for a stronger presence */
        }
        ...
        .main-image-container {
            width: 100%;
            max-width: 350px;
            /* Reduced max width for the main image */
            height: auto;
            position: relative;
            border: 2px solid #333;
            margin-right: 15px;
        ...
        #postTestContainer {
            ...
            color: #e0f7fa;
            /* Light color for improved readability */
            font-size: 15px;
        }
    ...
    <script>
        ...
        canvas.addEventListener('click', function() {
            ...
            questions[currentQuestion].answers.forEach((answer, i) => {
                ...
                const adjustedYPos =
                    300; // Match y position from drawTarget// Calculate X position for the target
                            ...
                            if (percentageScore >= 80) {
                                ...
                                setTimeout(() => {
                                    ...
                                    window.location.href =
                                        "{{ route('storylinestage1') }}"; // Restart the game
                                }, 3000);
