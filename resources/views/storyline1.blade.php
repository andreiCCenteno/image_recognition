...
<body>
    <div class="container">
        ...
        <div class="phase" id="artifact-analysis-phase" style="display: none;">
            <div class="dialogue">
                As you prepare to unlock the secrets of the artifact, you take a deep breath. Its surface holds ancient
                mysteries that could change history forever.
                <br><br>
                The first task is to enhance the artifact’s image. Using advanced preprocessing techniques, you’ll
                remove noise and reveal hidden patterns that have long been forgotten.
                <br><br>
        ...
        <div class="phase" id="image-recognition-intro" style="display: none;">
            <div class="dialogue">
                Welcome to the world of Image Recognition! To proceed further in your analysis, you must master two
                crucial techniques:
                <ul style="text-align: left; margin-top: 10px; margin-left: 40px;">
                    <li><strong>Preprocessing:</strong> Enhancing the artifact’s images by bringing out hidden patterns
                        and removing unwanted noise.</li>
                    <li><strong>Postprocessing:</strong> Examining the processed images to extract meaningful features
                        and gain insights.</li>
                </ul>
...
<div class="phase"  id="cnn-feature-extraction" style="display: none;">
    ...
    <div class="buttons">
        ...
        <div class="overlay" id="convolutionKernelOverlay">
            <h2>Convolution Kernel</h2>
            <div class="matrix" id="kernel"></div>
            <p class="instruction">A convolution kernel is a small matrix used in image processing to extract features
                from an image. It works by sliding over the input image, multiplying its values with the pixel values
                beneath it, and producing an output that highlights important features like edges, textures, and
                patterns. In image recognition, kernels help the model identify key elements in an image, such as shapes
                and boundaries, making it easier to classify objects or detect patterns.</p>
        </div>

        <div class="overlay" id="artifactMatrixOverlay">
            <h2>Input Matrix (Artifact Image)</h2>
            <div class="matrix" id="artifactMatrix"></div>
            <p class="instruction">This is the input image (artifact) matrix, representing the pixel values of the
                original image that will undergo processing. Each pixel in the image has a value that corresponds to its
                intensity or color. The convolution kernel will be applied to this matrix to extract features and
                transform the image for further analysis, such as edge detection, pattern recognition, or texture
                identification.</p>
        </div>
        ...
        <div class="overlay" id="outputMatrixOverlay">
            <h2>Output Matrix</h2>
            <div class="matrix" id="outputMatrix"></div>
            <p class="instruction">The output matrix represents the result of applying the convolution kernel to the
                input matrix. Each value in the output matrix is derived by applying the kernel to a specific region of
                the input image, highlighting features like edges, textures, or patterns. The output matrix helps in
                visualizing the features extracted from the original image, which are crucial for tasks like image
                recognition, classification, or further processing.</p>
        </div>
    ...
    <script>
        ...
        function classifyFeature() {
            ...
            const {
                sum: convolutionResult
            } = computeConvolution(artifact, kernel);
